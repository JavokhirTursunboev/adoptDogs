  ...
  return (
    <Provider store={store}>
      <QueryClientProvider client={queryClient}>
        ...
        >
          <div className="">
            <Link to={"/"} className="flex  backdrop-blur-sm text-[3rem] fixed w-full">
              <svg
